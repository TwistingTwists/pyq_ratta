defmodule PyqRatta.Telegram.SendHelpers do
  ...
  defp do_reply({:mp4, file}, chat_id, bot, tg_msg_opts) do
    opts = tg_msg_opts ++ [bot: bot, caption: file |> get_name, supports_streaming: true]
    ExGram.send_video(chat_id, {:file, file}, opts)
  end

  defp do_reply({:img, file}, chat_id, bot, tg_msg_opts) do
